...
#ifndef protoMessage_2eproto_2epb_2eh
#define protoMessage_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_protoMessage_2eproto
...
struct TableStruct_protoMessage_2eproto {
  static const ::uint32_t offsets[];
};
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_protoMessage_2eproto;
}  // extern "C"
...
/* @@protoc_insertion_point(class_definition:ProtoMessage.Message) */ {
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_protoMessage_2eproto;
};
...
PROTOBUF_ALWAYS_INLINE void Message::set_msg(Arg_&& arg, Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.msg_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:ProtoMessage.Message.msg)
}
inline ::std::string* PROTOBUF_NONNULL Message::mutable_msg()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline ::std::string* PROTOBUF_NONNULL Message::_internal_mutable_msg() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000001u;
  return _impl_.msg_.Mutable( GetArena());
}
inline ::std::string* PROTOBUF_NULLABLE Message::release_msg() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline void Message::set_allocated_msg(::std::string* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (value != nullptr) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
...
#endif  // protoMessage_2eproto_2epb_2eh
